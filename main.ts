...
let guestlist:string[] = ["Laiba", "Hina", "Alishba"]
...
let placetoVisit:string[] = ["China", "America", "Paris", "Italy", "Iran"]
//original order
...
//these items.
let languages:string[] = ["chinese", "french", "japnese", "urdu", "english"]
//print the list
console.log("languages list",languages.forEach(language =>{
